...
export default function App() {
  ...
  const content = !rankingData.length ? <div className="text-gray-500 w-full text-center py-20">Sem dados suficientes para listar competidores.</div> : page === 'overview' ? <GroupedOverviewPanel rankingData={rankingData} /> : page === 'ranking' ? <IndividualPanel rankingData={rankingData} /> : <InsightsPanel rankingData={rankingData} view={page} />;
