...
export default function App() {
  ...
  const content = !rankingData.length ? <div className="text-gray-500 w-full text-center py-20">Sem dados suficientes para listar competidores.</div> : page === 'overview' ? <GroupedOverviewPanel rankingData={rankingData} /> : page === 'podium' ? <OverviewPanel rankingData={rankingData} /> : page === 'ranking' ? <IndividualPanel rankingData={rankingData} /> : <InsightsPanel rankingData={rankingData} view={page} />;

  return <div className="dashboard-shell h-screen h-[100dvh] bg-[#F7F7FB] text-[#17131F] font-sans flex flex-col relative overflow-hidden">
