...
export default function App() {
  ...
  return <div className="dashboard-shell min-h-screen min-h-[100dvh] bg-[#F7F7FB] text-[#17131F] font-sans flex flex-col relative">
