...
export function DashboardWorkspace({ children, datasetData = [] }) {
  return <div className="dashboard-workspace w-full grid grid-cols-1 gap-3 items-stretch min-[1280px]:h-full min-[1280px]:grid-cols-[minmax(0,1fr)_clamp(260px,21vw,360px)]">
