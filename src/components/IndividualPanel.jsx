...
export function IndividualPanel({ rankingData }) {
  ...
  return <div className="w-full max-w-[1500px] mx-auto bg-white border border-[#E8E5EF] rounded-2xl shadow-lg overflow-hidden flex flex-col">
