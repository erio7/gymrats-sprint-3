...
export function ChallengeCountdown({ startDate, endDate }) {
  ...
  return (
    <div className="bg-gradient-to-br from-brand-50 to-white px-5 py-2.5 rounded-2xl border border-brand-100 flex flex-col justify-center min-w-[300px] shadow-sm">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex items-baseline gap-1 text-[#17131F] font-black text-xl tracking-tight">
